...
export default function ServicesPage() {
  return <>
    <PageHero title="Leistungen" subtitle="Was ich mit Herz und Erfahrung auf ihrem Weg in ein neues Leben – mit Zeit, Vertrauen und dem festen Glauben daran, dass jeder Schritt zählt." image="/media/247-diakoneo.jpg" />
